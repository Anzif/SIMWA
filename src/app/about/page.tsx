      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <div className="mb-10 max-w-3xl">
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            ...
            <img src="/images/logo-emblem.png" alt="SIMWA emblem" className="h-20 w-20 rounded-3xl border border-emerald-900/10 bg-white p-2 shadow-sm" />
          </div>
        </div>
        <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="rounded-3xl border border-emerald-900/10 bg-white p-8 shadow-sm">
            <div className="mb-6 flex items-center gap-4 rounded-3xl bg-[rgba(15,93,59,0.05)] p-6">
              <img src="/images/logo-emblem.png" alt="SIMWA emblem" className="h-16 w-16 rounded-2xl border border-emerald-900/10 bg-white/90 p-2" />
              <div>
